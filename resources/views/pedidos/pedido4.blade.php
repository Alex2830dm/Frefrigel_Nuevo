...
<div class="d-flex align-items-start">
    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <button class="nav-link <?php echo ($categoria->id == 1)?'active':''; ?>" id="v-pills-{{$categoria->id}}-tab" data-bs-toggle="pill" data-bs-target="#v-pills-{{$categoria->id}}"
            type="button" role="tab" aria-controls="v-pills-{{$categoria->id}}" aria-selected="false">{{$categoria->categoria}}</button>    
        @endforeach
    </div>
    <div class="tab-content" id="v-pills-tabContent">
        @foreach ($categorias as $categoria)
        <div class="tab-pane fade <?php echo ($categoria->id == 1)?'show active':''; ?>" id="v-pills-{{$categoria->id}}" role="tabpanel" aria-labelledby="v-pills-{{$categoria->id}}-tab">
